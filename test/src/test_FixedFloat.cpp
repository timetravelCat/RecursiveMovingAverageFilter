...
TEST_CASE("FixedFloat Class")
{
  ...
  // ...
  REQUIRE(getDigits(0.05f) == 11);
  REQUIRE(getDigits(0.5f) == 10);
  REQUIRE(getDigits(1.5f) == 9);
  REQUIRE(getDigits(10.5f) == 8);
  REQUIRE(getDigits(100.5f) == 7);

  REQUIRE(getLimits(11) == 1.0f / 10.0f);
  REQUIRE(getLimits(10) == 1.0f);
  REQUIRE(getLimits(9) == 1.0f * 10.0f);
  REQUIRE(getLimits(8) == 1.0f * 10.0f * 10.0f);
  REQUIRE(getLimits(7) == 1.0f * 10.0f * 10.0f * 10.0f);
